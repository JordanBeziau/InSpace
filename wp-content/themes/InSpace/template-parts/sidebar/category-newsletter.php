  ...
  <div class="wrapper newsletter">
    <div class="large-12 title">
      ...
      <form action="<?php echo get_template_directory_uri(); ?>/forms/test.php" method="post" id="newsletter-form">
        <input type="text" name="nom" class="newsletter-form" placeholder="NOM Prénom">
        <input type="text" name="mail" class="newsletter-form" placeholder="E-mail">
        <input type="text" name="societe" class="newsletter-form" placeholder="Société/Organisme">
        <input type="text" name="fonction" class="newsletter-form" placeholder="Fonction">
        <input type="tel" name="telephone" class="newsletter-form" placeholder="Téléphone">
